...
from fantasy_nba.players import FREE_AGENTS, retrieve_player_data
from fantasy_nba.schedule import team_games_to_play
from fantasy_nba.teams import TEAMS
...
class PlayerGroup:
    ...
    def retrieve_stats(self, sort: str = "Score", hide_injured: bool = False) -> DataFrame:
        ...
        stats_and_games["Pot.Week"] = stats_and_games["Score"] * stats_and_games["ThisWeekAmp"]
        stats_and_games["Pot.3Days"] = stats_and_games["Score"] * stats_and_games["Next3DaysAmp"]
        stats_and_games["Pot.NextWeek"] = stats_and_games["Score"] * stats_and_games["NextWeekAmp"]
        if hide_injured:
...
class FreeAgentPlayerGroup(PlayerGroup):
    ...
    def show_free_agents(self, sort: str, hide_injured: bool) -> None:
        ...
        pprint(PlayerGroup.retrieve_stats(self, sort=sort, hide_injured=hide_injured).head(500))
