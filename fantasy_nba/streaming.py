...
from fantasy_nba.playergroup import FreeAgentPlayerGroup
from fantasy_nba.players import FREE_AGENTS, retrieve_player_data
from fantasy_nba.schedule import NOW, Schedule
...
def drop_strictly_worse_players(dataframe: DataFrame, max_slots: int = 3) -> DataFrame:
    ...
    for pattern in game_day_patterns:
        ...
        rebuilt_dataframe = concat([rebuilt_dataframe, dataframe_per_pattern.head(max_slots)])
