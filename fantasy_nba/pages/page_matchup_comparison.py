...
from fantasy_nba.playergroup import OtherPlayerGroup
from fantasy_nba.tables import table_roster
...
def app():
    # Side bar
    with st.sidebar:
        SELECTED_TEAM_STR_1 = st.sidebar.selectbox(label="Fantasy Team 1", options=FANTASY_TEAMS)
        SELECTED_TEAM_STR_2 = st.sidebar.selectbox(label="Fantasy Team 2", options=FANTASY_TEAMS)
