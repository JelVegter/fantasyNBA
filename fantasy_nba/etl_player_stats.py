...
from fantasy_nba.full_player_stats import calculate_stat_points, clean_all_stats, get_all_stats
...
def load_player_stats(data: DataFrame) -> None:
    ...
    records = []
    for tup in data:
        records.append(tuple(None if element != element else element for element in tup))
