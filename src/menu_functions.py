...
def print_and_search_free_player() -> None:
    ...
    searched_player_list = [fa for fa in free_agent_list if searched_player in fa.name.lower()]
...
def print_and_search_free_player_teams() -> None:
    ...
    free_agent_list = retrieve_free_agents()
    searched_player_in_teams_list = [fa for fa in free_agent_list if fa.proTeam.lower() in teams]
